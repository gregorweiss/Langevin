...
public:
    ...
    void insert_flag(const string, const PT, int const);

    template<typename PT>
    void insert_flag(const string, const string, const PT, int const);

    template<typename PT>
    PT flag(const string &);

    template<typename PT>
    PT flag(const unsigned, const string &);

    template<typename PT>
    PT flag(const string &, const PT);

    template<typename PT>
    PT flag(const string &, const string &, const PT);

    template<typename PT>
    PT flag(const unsigned, const string &, const PT, int const);

    template<typename PT>
    bool is_parsed(const string &);

    template<typename PT>
    int flag_size(const string);

private:

    template<typename PT>
    void insert_flag(boost::shared_ptr<Argument<PT> >);

    template<typename PT>
    void insert_flag(const string, const PT, int const, int argc, char *argv[]);

    template<typename PT>
    void insert_flag(const string, const string, const PT, int const, int argc, char *argv[]);
...
template<typename PT>
void ArgParse::insert_flag(boost::shared_ptr<Argument<PT> > newflag) {
...
// inserts and defines a new object of class type Argument<PT> into iMap
template<typename PT>
void ArgParse::insert_flag(const string id, const PT val, int const size,
                           int argc, char *argv[]) {
...
// inserts and defines a new object of class type Argument<PT> into iMap
template<typename PT>
void ArgParse::insert_flag(const string id1, const string id2, const PT val, int const size,
                           int argc, char *argv[]) {
...
// obtains the value parsed with flag "key"
template<typename PT>
PT ArgParse::flag(const string &key1, const string &key2, const PT val) {
...
// obtains the value parsed into with flag "key" at position "n"
template<typename PT>
PT ArgParse::flag(const unsigned n, const string &key, const PT val, int const size) {
...
template<typename PT>
bool ArgParse::is_parsed(const string &key) {
...
template<typename PT>
int ArgParse::flag_size(const string key) {
